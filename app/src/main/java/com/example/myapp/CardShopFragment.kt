...
class CardShopFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_card_shop, container, false)

        editTextCard = view.findViewById(R.id.editTextTextPersonName2)
        editTextCVV = view.findViewById(R.id.editTextTextPersonName10)
        editTextExpiryDate = view.findViewById(R.id.editTextTextPersonName11)
                ...
                if (currentUser != null) {
                    ...
                    fetchOrders(currentUserEmail, object : TransferAddressFragment.EmailTaskCallback {
                        override fun onOrdersFetched(orders: String?, sum: Double) {
                            ...
                            deleteUserOrders()
                            findNavController().navigate(R.id.action_cardShopFragment_to_clientMenuFragment)
                        }
                    })
                }
            } else {
    ...
    private fun sendEmail(orders: String, sum: Double) {
        ...
        val request = MailjetRequest(Emailv31.resource)
            .property(Emailv31.MESSAGES, JSONArray().put(JSONObject().apply {
                ...
                put(
                    Emailv31.Message.HTMLPART, "<h1>Rachunek został opłacony</h1>" +
                            "<p>Orders:</p>" +
                            "<p>$orders</p>" +
                            "<p>Total: zl$sum</p>" +
